...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Silahkan login sebagai <b class="text-primary">Pasien</b> untuk
    ...
    <div class="text-center mt-3">Login Sebagai <a href="login.php"><span class="text-primary">Dokter</span></a>
    </div>
    </div>
    <!-- /.login-box -->
